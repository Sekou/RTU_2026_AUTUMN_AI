...
if __name__=="__main__":
    ...
    while True:
        ...
        for iter in range(SIM_SPEED):
            if dist(robot.get_pos(), objs[-1].get_pos())>20:
                fvec=calc_force(robot, objs)
